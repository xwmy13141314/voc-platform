...
### README 界面截图（补齐）
- 新增 `screenshots/` 目录：仪表盘 / 数据采集 / 洞察看板 / 改良建议 4 张主界面截图（Playwright + Edge 无头拍摄，README 此前的图片引用首次真正可用）
- 截图全部经过品牌/型号/赛道脱敏：品牌 → 竞品A-N，型号 → 竞品机型，三防手机/rugged → 电子产品/旗舰；采用 DOM 文本替换 + ECharts option 重写双重遮蔽，截图前对页面全文与图表数据做确定性关键词扫描，确认零残留
